...
<center><img width="300" height="300" style="border-radius: 25%;" alt="bandwagon" src="https://github.com/user-attachments/assets/aab3fb46-612a-43f8-90d9-436f79fa0ffe"></center>
...
2. Creates CSV files with the stock prices for analysis and historical purposes. It creates and saves a CSV file for each stock in the PriceData directory. It also creates a rolling 180 day history in stockQuotes.csv. Lastly, it creates a stockQuotes[Year].csv for each year of stock data consumed.
